...
#cargar el dataframe
df = pd.read_csv("/dbfs/mnt/PagWeb/Extract/Vendidos/vendidos_web_AllClean.csv")

#lista de columnas para quitar acentos
columns_to_modify = [
...
#quitar acentos de los registros
output_path = "/dbfs/mnt/PagWeb/Extract/Vendidos/vendidos_web_Acentos.csv"
